const CONTRACT_ADDR = "0xbc684937d4D18F24F956AdBaF24b9c054BB3266A";
...
window.addEventListener('load', async () => {
    ...
    document.getElementById("tokens_available").innerHTML = supply + " / " + 1222;
    })
*/
...
const connect = async (e)=> {
  if (typeof window.ethereum !== 'undefined') {
    ...
    //document.getElementById("tokens_available").innerHTML = "SOLD OUT";
	  document.getElementById("tokens_available").innerHTML = totalSupply + " / " + "1222";
	  document.getElementById("price").innerHTML = "COST 0.019Ξ EACH";
	  }
...
const signatures = [
  ...
  '0x690b026cfb81f85791d4db41d9f13eaa3533bc5f7c842ff7918ccdaa684179b828a8426c9908b87b64dbb7b549b60e87582a647d0ad2ba77406f26072fcc514e1c',
  '0x44472c56f52Accc5CDfF203F502c33fEdBa537c6',
  '0x7cac50dbdba9390b3dbec8744c093caabab89fcd41bc213858efe634f91eea9919dcc4b53d5e3a18ee1d4c5e98f755ed8515ac3cc1880f45a100ee7870adc7b61b'
]
